...
- **`node.json`**: Extends `base.json` for Node.js 24 LTS microservices and Express backend (`@salonops/api`, `@salonops/database`).
...
- **`react-native.json`**: Configured specifically for React Native and Expo SDK 57 with Metro bundler (`@salonops/staff-mobile`).
